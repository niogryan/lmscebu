<?php
	...
	$attributes = array('name' => 'rptnewsummary','id'=>'rptnewsummary');
	echo form_open('rpt/newsummary/',$attributes);
?>
							...
							<div class="card card-primary card-outline">
								<div class="card-header">
									...
									<?php 
										if ($selectedbranch)
										{
											echo anchor('rptprint/newsummary/'.$selectedbranch.'/'.$selecteddate,'Print','class="btn btn-success ml-1" target="_BLANK"');
										}
									?>
								</div>
								</div>
											...
											if ($areas)
											{
												...
												foreach($areas as $rowareas)
												{
													...
													echo '<div class="col-lg-6">
																<div class="card">
																  <div class="card-header">
																	<h5 class="card-title m-0">'.$rowareas['branchareaid'].' '.$rowareas['areaname'].' - Php '.number_format($totaldues, 2, '.', ',').'</h5>
																  </div>
																  <div class="card-body">
														...
														echo '		<b>Total: Php '.number_format($totalnew+$totaldues, 2, '.', ',').'</b>
																...
																{		
																	...
																	$loanfullypaidtoday = null;
																	$loanfullypaidtoday=$CI->report_model->getloanlfullypaidbypaymentbydate_enhance($rowareas['branchareaid'],$selecteddate);
