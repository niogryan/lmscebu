...
<html lang="en-ph">
	...
	<body>
		...
		<div style="clear:both; margin-left:730px;">Date Genereated: <?php echo date("F d, Y"); ?></div>
		<br />
						...
						for($ctr=0;$ctr<=(count($areas)-1);$ctr++)
						{
							...
							echo '<td style="width:500px;" valign="top">';
								...
								if(strtolower(date("l", strtotime($selecteddate))) != "sunday")
								{
									...
									$loanfullypaidtoday=$CI->report_model->getloanlfullypaidbypaymentbydate_enhance($areas[$ctr]['branchareaid'],$selecteddate);
